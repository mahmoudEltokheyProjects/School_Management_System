...
<div style="display: none" class="row setup-content" id="step-2">
    ...
    <div class="col-xs-12">
        <div class="col-md-12">
            ...
            {{-- ================================ Row 3 ================================ --}}
            <div class="form-row">
                {{-- Nationality_Father_id Selectbox --}}
                ...
                {{-- Blood_Type_Father_id Selectbox --}}
